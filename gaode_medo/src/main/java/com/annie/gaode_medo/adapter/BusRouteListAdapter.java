...
import com.annie.gaode_medo.RouteDetailActivity;
...
public class BusRouteListAdapter extends BaseAdapter{
    ...
    public BusRouteListAdapter(Context context, BusRouteResult busrouteresult) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(mContext, R.layout.bus_search_result_item, null);
